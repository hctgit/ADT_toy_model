// Compilation command: g++ -std=c++11 -o adt_excitation adt_excitation.cpp
...
//  cin >> Nturns;
  cout << "Enter excitation time in seconds\n";
  cin >> time;
  Nturns = time*rev_f;
  ...
  while (j <= Npart){    
    ...
    tune_adt = tune_adt_0;
    myfile0 << j << " " << n << " " << x0 << " " << p0 << " " << amplitude <<" " << tune_adt << endl;
